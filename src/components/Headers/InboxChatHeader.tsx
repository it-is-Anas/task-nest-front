...
export default function InboxChatHeader({closeChat=()=>console.log('didn\'t initail')}:{closeChat:()=>void}){
    return (
        <header className="inbox-page-chat-column_chat-header">
            ...
            <img onClick={closeChat} src={MobileMenuIcon} alt="" className="inbox-header_btn chat-icon" />
        </header>
    );
}